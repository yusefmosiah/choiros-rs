...
impl CitationKindEnumBuilder {
    ...
    pub fn value_BuildsOn(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("BuildsOn").expect(
            "CitationKind.BuildsOn is statically defined in .baml and should always be present",
        )
    }

    /// Access the `Contradicts` value builder.
    pub fn value_Contradicts(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("Contradicts").expect(
            "CitationKind.Contradicts is statically defined in .baml and should always be present",
        )
    }

    /// Access the `Reissues` value builder.
    pub fn value_Reissues(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("Reissues").expect(
            "CitationKind.Reissues is statically defined in .baml and should always be present",
        )
    }
}
...
impl ConductorActionEnumBuilder {
    ...
    pub fn value_Delegate(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("Delegate").expect(
            "ConductorAction.Delegate is statically defined in .baml and should always be present",
        )
    }
}
...
impl ContextSourceKindEnumBuilder {
    ...
    pub fn r#type(&self) -> baml::TypeDef {
        self.inner.as_type().expect(
            "ContextSourceKind is statically defined in .baml and should always have a type",
        )
    }
...
impl NextActionKindEnumBuilder {
    ...
    pub fn value_ToolCalls(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("ToolCalls").expect(
            "NextActionKind.ToolCalls is statically defined in .baml and should always be present",
        )
    }

    /// Access the `Program` value builder.
    pub fn value_Program(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("Program").expect(
            "NextActionKind.Program is statically defined in .baml and should always be present",
        )
    }

    /// Access the `FanOut` value builder.
    pub fn value_FanOut(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("FanOut").expect(
            "NextActionKind.FanOut is statically defined in .baml and should always be present",
        )
    }

    /// Access the `Recurse` value builder.
    pub fn value_Recurse(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("Recurse").expect(
            "NextActionKind.Recurse is statically defined in .baml and should always be present",
        )
    }
    ...
    pub fn value_Complete(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("Complete").expect(
            "NextActionKind.Complete is statically defined in .baml and should always be present",
        )
    }
    ...
    pub fn value_Block(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("Block").expect(
            "NextActionKind.Block is statically defined in .baml and should always be present",
        )
    }
}
...
impl WorkerKindEnumBuilder {
    ...
    pub fn value_Researcher(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("Researcher").expect(
            "WorkerKind.Researcher is statically defined in .baml and should always be present",
        )
    }
    ...
    pub fn value_Terminal(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("Terminal").expect(
            "WorkerKind.Terminal is statically defined in .baml and should always be present",
        )
    }

    /// Access the `Subharness` value builder.
    pub fn value_Subharness(&self) -> baml::EnumValueBuilder {
        self.inner.get_value("Subharness").expect(
            "WorkerKind.Subharness is statically defined in .baml and should always be present",
        )
    }
}
