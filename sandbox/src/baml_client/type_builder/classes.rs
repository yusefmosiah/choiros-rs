...
impl AgentDecisionClassBuilder {
    ...
    pub fn property_action(&self) -> baml::ClassPropertyBuilder {
        self.inner.get_property("action")
            .expect("AgentDecision.action is statically defined in .baml and should always be present")
    }
    ...
    pub fn property_summary(&self) -> baml::ClassPropertyBuilder {
        self.inner.get_property("summary")
            .expect("AgentDecision.summary is statically defined in .baml and should always be present")
    }
    ...
    pub fn property_reason(&self) -> baml::ClassPropertyBuilder {
        self.inner.get_property("reason")
            .expect("AgentDecision.reason is statically defined in .baml and should always be present")
    }
...
impl AgentToolArgsClassBuilder {
    ...
    pub fn property_old_text(&self) -> baml::ClassPropertyBuilder {
        self.inner.get_property("old_text")
            .expect("AgentToolArgs.old_text is statically defined in .baml and should always be present")
    }
    ...
    pub fn property_new_text(&self) -> baml::ClassPropertyBuilder {
        self.inner.get_property("new_text")
            .expect("AgentToolArgs.new_text is statically defined in .baml and should always be present")
    }
