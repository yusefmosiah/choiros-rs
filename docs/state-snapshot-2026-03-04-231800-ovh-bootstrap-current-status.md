...
|------|---------|-----------|
| docs/ovh-config-and-deployment-entrypoint.md | Single OVH bootstrap/deployment entrypoint | New comprehensive big-picture doc for re-onboarding |
...
| docs/adr-0012-ovh-us-east-bootstrap-secrets-and-compute-lifecycle.md | Accepted OVH bootstrap ADR | Decision authority for secrets and two-node lifecycle |
...
| docs/ovh-config-and-deployment-entrypoint.md | New comprehensive OVH bootstrap/deployment entrypoint with map/checklist | Provide single big-picture re-onboarding doc |
| docs/state-snapshot-2026-03-04-231800-ovh-bootstrap-current-status.md | New handoff summarizing current status and next steps | Preserve session context and actionable continuation |
...
- The new OVH entrypoint doc was originally created during this session and now lives at `docs/ovh-config-and-deployment-entrypoint.md`.
