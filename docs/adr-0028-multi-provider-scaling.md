...
- Capacity stress test: `docs/state-report-2026-03-11-capacity-stress-test.md`
- ADR-0022 concurrency findings: `docs/adr-0022-hypervisor-concurrency-and-capacity.md`
- ADR-0003 secrets boundary: `docs/adr-0003-hypervisor-sandbox-secrets-boundary.md`
- BYOK/provider auth session notes: `docs/note-2026-03-11-agent-architecture-session-notes.md` (section 3)
