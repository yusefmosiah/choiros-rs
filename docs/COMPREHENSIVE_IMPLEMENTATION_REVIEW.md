...
The React implementation (`sandbox-ui`) has solid foundations with working Chat and Terminal apps, functional WebSocket connections, and a reasonable API client layer. However, significant gaps exist compared to the Dioxus backup:
