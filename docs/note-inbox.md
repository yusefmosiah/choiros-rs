...
- [ ] Review [CI Boundaries and the Bootstrap Thesis](/Users/wiz/choiros-rs/docs/note-2026-03-11-ci-boundaries-and-bootstrap-thesis.md) and decide which parts should graduate into ADR-0014 / ADR-0024 language
...
- [x] Orchestration layer between conductor and app agents — captured in
  `docs/note-2026-03-11-agent-architecture-session-notes.md`. Decision:
