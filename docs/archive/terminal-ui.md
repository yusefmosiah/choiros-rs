...
## JS Bridge Plan
Create `dioxus-desktop/assets/terminal.js` that exports:
...
- `dioxus-desktop/public/xterm.js` (xterm.js 5.3.0)
- `dioxus-desktop/public/xterm-addon-fit.js` (fit addon 0.8.0)
- `dioxus-desktop/public/xterm.css`

`dioxus-desktop/dioxus.toml` sets `asset_dir = "public"` so `dx serve` serves these at `/`.
...
- JS bridge added in `dioxus-desktop/assets/terminal.js` using xterm.js + fit addon.
- `TerminalView` implemented in `dioxus-desktop/src/terminal.rs`.
- `TerminalView` wired into `dioxus-desktop/src/desktop.rs` for app id `terminal`.
