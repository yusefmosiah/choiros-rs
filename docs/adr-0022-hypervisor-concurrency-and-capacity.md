...
- Capacity stress test report: `docs/state-report-2026-03-11-capacity-stress-test.md`
- DAX vs no-DAX load test: `docs/state-report-2026-03-11-dax-vs-nodax-load-test.md`
